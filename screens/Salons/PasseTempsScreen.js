...
const PasseTempsScreen = ({navigation}) => {
    ...
    useLayoutEffect(() => {
        const unsubscribe = db.collection('passe-temps').orderBy('createdAt','desc').onSnapshot(snapshot=>setMessages(
...
export default PasseTempsScreen