    ...
    return (
        ...
        <KeyboardAwareScrollView style={{backgroundColor: '#FFF'}}>
          ...
          <View style ={{flex: 1, padding: 5, alignItems: 'center', backgroundColor: '#FFF'}}>
            ...
            <Text style={{fontSize: 18, fontWeight: 'bold', marginTop: 30, marginBottom: 20}}>Voici le formulaire pour rentrer un lieu culturel : </Text>

            <View>
              <MaterialIcons name={'person-outline'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
              <Input style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
              placeholder="entrer le nom" label = "nom" value = {nom} onChangeText={text => setNom(text)}/>
            </View>
            
            <View>
              <MaterialIcons name={'room'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
              <Input style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
              placeholder = "entrer le lieu" label = "lieu" value = {lieu} onChangeText = {text => setLieu(text)}/>
            </View>
            
            <View>
              <MaterialIcons name={'euro'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
              <Input style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
              placeholder = "entrer le prix" label = "prix" value = {prix} onChangeText = {text => setPrix(text)}/>
            </View>

            <View>
              <MaterialIcons name={'help-outline'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
              <Input style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
              placeholder = "entrer la description du lieu" label = "description" value = {description} onChangeText = {text => setDesciption(text)} />
            </View>
                  
            <View>
              <MaterialIcons name={'accessible'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
              <Input style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
              placeholder = "entrer le type de handicap accepté" label = "handicap" value = {handicap} onChangeText = {text => setHandicap(text)} />
            </View>


            <View>
              <MaterialIcons name={'link'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
              <Input style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45, marginBottom: 25}}
              placeholder="entrer l'url du site" label = "site" value = {site} onChangeText = {text => setSite(text)}/>
            </View>
