...
export const WriteUserData_Consultant = async (nomPrenom, mail, motDePasse, confirmationDuMotDePasse) => {

    try{

        return await firebase.database().ref('/Utilisateurs/Consultants/' + nomPrenom).set({
            mail : mail,
...
export const WriteConsultant = async (honoraire, ville) => {

    try{

      return await firebase.database().ref('/Utilisateurs/Consultants/-- Informations --/' + nomAssociation).set({
          honoraire: honoraire,
          ville: ville,
...
export const WriteAssociation = async (nomAssociation, activite, telephone, ville, typeHandicap, tarifs, horairesEntrainement, documents, trancheAge, autres) => {
    ...
    try{
      ...
      return await firebase.database().ref('/Utilisateurs/Associations/-- Informations --/' + nomAssociation).set({
          ...
          tarifs: tarifs,
          horairesEntrainement: horairesEntrainement,
          documents: documents,
