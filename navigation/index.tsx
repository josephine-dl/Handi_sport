...
function ListeAssociations({navigation}) {
  ...
  const information = () => {
    WriteAssociation(state.nomAssociation, state.activite, state.telephone, state.ville, state.typeHandicap, state.tarifs, state.horairesEntrainement, state.documents, state.trancheAge, state.autres)
  ...
  return(
    ...
    <View style ={{flex: 1, padding: 5, alignItems: 'center', backgroundColor: '#FFF'}}>
      ...
      <Text style={{fontSize: 18, fontWeight: 'bold', marginTop: 7, marginBottom: 10}}>Formulaire associations</Text>
      ...
      <View>
        <MaterialIcons name={'euro'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
        <TextInput style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
        placeholder='Tarifs' value={state.tarifs} onChangeText={(text) => setState({...state,tarifs:text})}/>
      </View>

      <View>
        <MaterialIcons name={'help-outline'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
        <TextInput style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
        placeholder='Tranche âge' value={state.trancheAge} onChangeText={(text) => setState({...state,trancheAge:text})} />
      </View>

      <View>
        <MaterialIcons name={'schedule'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
        <TextInput style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
        placeholder='Horaires entraînement' value={state.horairesEntrainement} onChangeText={(text) => setState({...state,horairesEntrainement:text})} />
      </View>

      <View>
        <MaterialIcons name={'description'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
        <TextInput style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
        placeholder='Documents à fournir (inscription)' value={state.documents} onChangeText={(text) => setState({...state,documents:text})} />
      </View>

      <View>
        <MaterialIcons name={'description'} size={28} color='#00CCCB' style ={{position: 'absolute', top: 16, left: 18, color: '#B22222'}}/>
        <TextInput style={{borderWidth: 1, borderColor: '#00CCCB', borderRadius: 10, padding: 8, margin: 10, width: 350, paddingLeft: 45}}
        placeholder='Informations complémentaires' value={state.autres} onChangeText={(text) => setState({...state,autres:text})} />
      </View>

        <TouchableOpacity onPress= {information}
          style={{backgroundColor: '#00CCCB', padding: 10, width: 250, borderRadius: 30, marginHorizontal: 2, marginTop: 4}}>
          <Text style={{textAlign: 'center', color: '#FFF', fontSize: 18, fontWeight: 'bold'}}>Valider</Text>
        </TouchableOpacity>
